...
class ButterFlyNet2D_CNN(nn.Module):
    def __init__(self, in_channel, height, width,
        ...
        super(ButterFlyNet2D_CNN, self).__init__()
    ...
    def forward(self, input_data):
        ...
        out_A = out_joint.view((input_data.shape[0], self.in_channel_num, self.frequency_kx_length, self.frequency_ky_length))
